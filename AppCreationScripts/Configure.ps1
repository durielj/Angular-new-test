...
Function ConfigureApplications {
    ...
    Write-Host "Creating the AAD application (ms-identity-javascript-angular-spa)"
    ...
    Write-Host "Done creating the spa application (ms-identity-javascript-angular-spa)"
    ...
    Add-Content -Value "<tr><td>spa</td><td>$currentAppId</td><td><a href='$spaPortalUrl'>ms-identity-javascript-angular-spa</a></td></tr>" -Path createdApps.html
